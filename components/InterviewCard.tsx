...
const InterviewCard = ({ interviewId,
                       userId, role, type, techstack, createdAt} : InterviewCardProps) => {
    ...
    return (
        <div className="card-border w-[460px]
                ...
                <div>
                    ...
                    <p className="line-clamp-2 mt-5">
                        {feedback?.finalAssessment || 
                            "You haven't taken this Interview yet. Take it now to improve skills."}
                    </p>
                </div>
